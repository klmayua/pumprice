      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
          {items.map((item, index) => (
            ...
            >
              <div
                className="rounded-[24px] p-6 md:p-7 h-full transition-all duration-500 relative overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <item.icon className="w-6 h-6 md:w-7 md:h-7 text-[#FFF200]" />
                  </div>

                  <h3 className="text-lg md:text-xl font-bold text-white mb-2">
                    {item.title}
                  </h3>
                  <p className="text-sm md:text-base text-[#8A8A8A] leading-relaxed group-hover:text-[#C7C7C7] transition-colors duration-300">
                    {item.description}
                  </p>
                </div>
              </div>
